...
from .db import set_team, get_chat_team, get_team_points, new_qr_scan, set_new_qr
...
async def start_cmd(e):
    ...
    msg = await e.reply(
        ...
        buttons=[[Button.inline("Set Team Name", b"set_team_name")]],
    )
